CPI = (function ($) {
        ...
        return this.each(function () {
            ...
            var updateTargets = function () {
                $.each($targets, function (i, $target) {
                    ...
                    if (
                        $target.val() != "" &&
                        !$target.hasClass("js-autochanged")
                    ) {
                        return;
                    }
    ...
    $.fn.combobox = function () {
        return this.each(function () {
            ...
            ($input_group = $('<div class="input-group">')),
                ...
                ($button = $(
                    '<button class="js-dropdown-toggle btn btn-default" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">'
                ).attr("id", dropdown_id)),
                ($button_caret = $(
                    '<span class="glyphicon glyphicon-menu-down">'
                )),
                ($clear_button = $(
                    '<button class="js-clear btn btn-default" type="button">'
            ...
            instance.filterOptions = function (event) {
                ...
                if (input_value == "" || !this.initialized) {
                    ...
                    $filtered_options = $dropdown_options.filter(
                        '[data-search*="' + input_value.toLowerCase() + '"]'
                    );
            ...
            $input.on(
                "keyup input input-from-combobox input-clear",
                function (event) {
        ...
        return this.each(function () {
            ...
            var uploadComplete = function (evt) {
                ...
                if ("location" in responseJson) {
                    ...
                    var error =
                        "There may have been an error uploading the file. Please try again and report if this happens a second time.";
            ...
            var uploadFailed = function (evt) {
                alert(
                    "There was an error uploading the file. Please try again and report if this happens a second time."
                );
            ...
            var uploadCanceled = function (evt) {
                alert(
                    "The upload has been canceled by the user or the browser dropped the connection. Please try again."
                );
                $progress_container.addClass("hidden");
                $input.val("");
            };
            ...
            $(this).on("change combobox-change", function () {
                var from_class = $from
                    ...
                    to_class = $to
                        ...
                        .data("classification"),
                    from_internal =
                        from_class == "Bank Account" ||
                        from_class == "Credit Card",
                    to_internal =
                        to_class == "Bank Account" || to_class == "Credit Card",
    ...
    $(function () {
        ...
        const transaction_id =
            $transaction_id.length > 0 ? $transaction_id.val() : false;
        ...
        // Simple stuff:
        $(".js-click").click();
        $(".js-hide").addClass("hidden").removeClass("js-hide");
        ...
        $(".js-clear").on("click", function () {
            ...
            $targets.each(function () {
                const $target = $(this);
                if ($target.is("input")) {
                    $target.val("").trigger("input-clear");
